...
{
    public class SaveDevelopmentTabsModal
    {
        ...
        public static string EnterNameAndSave(string tuneSetName = null)
        {
            string enteredTuneSetName = EnterTuneSetName(tuneSetName);
            Check.AreEqual(enteredTuneSetName, NameTextBox.Text, "The entered tune set name is as expected");
        ...
        public static string EnterTuneSetName(string tuneSetName = null)
        {
            ...
            NameTextBox.TrySetText(tuneSetName);
